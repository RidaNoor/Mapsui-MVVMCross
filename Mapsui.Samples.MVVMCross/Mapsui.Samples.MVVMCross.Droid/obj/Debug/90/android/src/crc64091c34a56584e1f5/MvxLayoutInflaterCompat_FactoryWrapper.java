...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross.Binding.Droid", MvxLayoutInflaterCompat_FactoryWrapper.class, __md_methods);
	}
	...
	public MvxLayoutInflaterCompat_FactoryWrapper ()
	{
		...
		if (getClass () == MvxLayoutInflaterCompat_FactoryWrapper.class)
			mono.android.TypeManager.Activate ("MvvmCross.Binding.Droid.Binders.MvxLayoutInflaterCompat+FactoryWrapper, MvvmCross.Binding.Droid", "", this, new java.lang.Object[] {  });
	}
